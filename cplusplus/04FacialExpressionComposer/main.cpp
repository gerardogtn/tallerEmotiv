...
const char * composerIp = "127.0.0.1";
const unsigned int composerPort = 1726;
...
void initializeEmotivEngine() {
    if (IEE_EngineRemoteConnect(composerIp, composerPort) != EDK_OK) {
        throw std::runtime_error("Cannot connect to emo composer");
    }
